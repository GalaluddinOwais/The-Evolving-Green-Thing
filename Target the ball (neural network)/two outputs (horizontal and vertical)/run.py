...
NERVE_IMPULSE = 10  #force (nerves output) is applied continuously (every single frame)
POPULATION = 20
GENERATIONS = 40000
...
def fitness(v1, w1, d1, v2, w2, d2, v3, w3, d3, v4, w4, d4,VVV1,VVVV1,VVV2,VVVV2,VVV3,VVVV3,VVV4,VVVV4,D1,D2):
    return physics.manifest(v1, w1, d1, v2, w2, d2, v3, w3, d3, v4, w4, d4,VVV1,VVVV1,VVV2,VVVV2,VVV3,VVVV3,VVV4,VVVV4,D1,D2)
...
def crossover(fitness_and_chromosome1, fitness_and_chromosome2, fitness_and_chromosome1_to_replace,
    ...
    random_gene_number = int(random.uniform(1, 21))   # 1 -- length-1
    # copy to crossover
    ...
    chromosome_1_copy[0] = fitness(chromosome_1_copy[1][0], chromosome_1_copy[1][1], chromosome_1_copy[1][2],
                                   ...
                                   chromosome_1_copy[1][18], chromosome_1_copy[1][19], chromosome_1_copy[1][20],
                                   chromosome_1_copy[1][21]
                                   )
    chromosome_2_copy[0] = fitness(chromosome_2_copy[1][0], chromosome_2_copy[1][1], chromosome_2_copy[1][2],
                                   ...
                                   chromosome_2_copy[1][18], chromosome_2_copy[1][19], chromosome_2_copy[1][20],
                                   chromosome_2_copy[1][21])
...
def mutate(fitness_and_chromosome, fitness_and_chromosome_to_replace):
        ...
        for _ in range(int(random.uniform(1, 5))):  # random mutating energy hitting (1 to 4) alleles in a chromosome
            list_of_random_genes_to_mutate.append(int(random.uniform(0, 22))) #0 -- length
        ...
        chromosome_copy[0] = fitness(chromosome_copy[1][0], chromosome_copy[1][1], chromosome_copy[1][2],
                                     ...
                                     chromosome_copy[1][12],chromosome_copy[1][13],chromosome_copy[1][14],
                                     chromosome_copy[1][15],chromosome_copy[1][16],
                                     chromosome_copy[1][17],
                                     chromosome_copy[1][18], chromosome_copy[1][19], chromosome_copy[1][20],
                                     chromosome_copy[1][21])
...
for _ in range(POPULATION):
    chromosomes.append([random.uniform(-NERVE_IMPULSE, NERVE_IMPULSE), random.uniform(-NERVE_IMPULSE, NERVE_IMPULSE), random.uniform(-NERVE_IMPULSE, NERVE_IMPULSE),
                        ...
                        random.uniform(-NERVE_IMPULSE, NERVE_IMPULSE), random.uniform(-NERVE_IMPULSE, NERVE_IMPULSE), random.uniform(-NERVE_IMPULSE, NERVE_IMPULSE),
                        random.uniform(-NERVE_IMPULSE, NERVE_IMPULSE), random.uniform(-NERVE_IMPULSE, NERVE_IMPULSE), random.uniform(-NERVE_IMPULSE, NERVE_IMPULSE),
                        random.uniform(-NERVE_IMPULSE, NERVE_IMPULSE), random.uniform(-NERVE_IMPULSE, NERVE_IMPULSE),
                        random.uniform(-NERVE_IMPULSE, NERVE_IMPULSE), random.uniform(-NERVE_IMPULSE, NERVE_IMPULSE),
                        random.uniform(-NERVE_IMPULSE, NERVE_IMPULSE),
...
for chromosome in chromosomes:
    fitnessValue = fitness(chromosome[0], chromosome[1], chromosome[2], chromosome[3], chromosome[4], chromosome[5],
                           ...
                           chromosome[12],chromosome[13],chromosome[14],chromosome[15],chromosome[16],chromosome[17],chromosome[18],chromosome[19],
