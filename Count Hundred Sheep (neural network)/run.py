...
FORCE = 6 #consider the force (weight) to calculate the maximum possible output from the nn (if it is possible to tell the maximum output needed, consdider it to determine the maximum force(weight))
BIAS = 3500*2 #the maximum possible output*2
POPULATION = 30
GENERATIONS = 40000
CROSS_OVERS_A_GENERATION = 8
MUTATIONS_A_GENERATION = 6
FIRST_CHROMOSOMES_TO_VIEW = 20


def fitness(vv1, vv2, vv3, vv4, vv5, vvv1, vvv2, vvv3, vvv4, vvv5, vvvv1, vvvv2, vvvv3,
                       vvvv4, vvvv5,d,D):
    return physics.manifest(vv1, vv2, vv3, vv4, vv5, vvv1, vvv2, vvv3, vvv4, vvv5, vvvv1, vvvv2, vvvv3,
                       vvvv4, vvvv5,d,D)
...
def mutate(fitness_and_chromosome, fitness_and_chromosome_to_replace):
    ...
    for _ in range(int(random.uniform(1, 7))):  # random mutating energy hitting (1 to 6) alleles in a chromosome
...
for _ in range(POPULATION):
    chromosomes.append([random.uniform(-FORCE, FORCE), random.uniform(-FORCE, FORCE), random.uniform(-FORCE, FORCE),
                        random.uniform(-FORCE, FORCE), random.uniform(-FORCE, FORCE), random.uniform(-FORCE, FORCE),
                        random.uniform(-FORCE, FORCE), random.uniform(-FORCE, FORCE), random.uniform(-FORCE, FORCE),
                        random.uniform(-FORCE, FORCE), random.uniform(-FORCE, FORCE), random.uniform(-FORCE, FORCE),
                        random.uniform(-FORCE, FORCE), random.uniform(-FORCE, FORCE), random.uniform(-FORCE, FORCE),
                        random.uniform(-BIAS, BIAS), random.uniform(-BIAS, BIAS)])
