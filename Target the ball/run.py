...
def crossover(fitness_and_chromosome1, fitness_and_chromosome2, fitness_and_chromosome1_to_replace,
    ...
    print('↓')
    if chromosome_1_copy[0] != copy.deepcopy(fitness_and_chromosome1)[0] and chromosome_1_copy[0] != \
            copy.deepcopy(fitness_and_chromosome2)[0]:
    ...
    if chromosome_2_copy[0] != copy.deepcopy(fitness_and_chromosome1)[0] and chromosome_2_copy[0] != \
            copy.deepcopy(fitness_and_chromosome2)[0]:
...
def mutate(fitness_and_chromosome, fitness_and_chromosome_to_replace):
    ...
    for random_gene_number in [int(random.uniform(0, 9)), int(random.uniform(0, 9)), int(random.uniform(0, 9))]:
        if random_gene_number in [0, 3, 6]:
            chromosome_copy[1][random_gene_number] = int(random.uniform(1, 30))
        else:
    ...
    print('↓')
    if chromosome_copy[0] != copy.deepcopy(fitness_and_chromosome)[0]:
...
chromosomes = []
for _ in range(100):
    chromosomes.append([int(random.uniform(1, 30)), random.uniform(-FORCE, FORCE), random.uniform(-FORCE, FORCE),
                        int(random.uniform(1, 30)), random.uniform(-FORCE, FORCE), random.uniform(-FORCE, FORCE),
                        int(random.uniform(1, 30)), random.uniform(-FORCE, FORCE), random.uniform(-FORCE, FORCE)])
...
print('Gen', 0, '  (fittest 10)')
print(chromosomes_ranked_by_fitness[0])
print(chromosomes_ranked_by_fitness[1])
print(chromosomes_ranked_by_fitness[2])
print(chromosomes_ranked_by_fitness[3])
print(chromosomes_ranked_by_fitness[4])
print(chromosomes_ranked_by_fitness[5])
print(chromosomes_ranked_by_fitness[6])
print(chromosomes_ranked_by_fitness[7])
print(chromosomes_ranked_by_fitness[8])
print(chromosomes_ranked_by_fitness[9])

for i in range(1, 10000000):

    for ii in range(2):
        crossover(chromosomes_ranked_by_fitness[int(random.uniform(0, 10))],
                  chromosomes_ranked_by_fitness[int(random.uniform(0, 10))],
                  chromosomes_ranked_by_fitness[-int(random.uniform(1, 10))],
                  chromosomes_ranked_by_fitness[-int(random.uniform(1, 10))],
                  )
    ...
    for iii in range(3):
        mutate(chromosomes_ranked_by_fitness[int(random.uniform(0, 20))],
               chromosomes_ranked_by_fitness[-int(random.uniform(1, 20))])

        chromosomes_ranked_by_fitness.sort()
        chromosomes_ranked_by_fitness.reverse()

    print('Gen', i, '  (fittest 10)')
    print(chromosomes_ranked_by_fitness[0])
    print(chromosomes_ranked_by_fitness[1])
    print(chromosomes_ranked_by_fitness[2])
    print(chromosomes_ranked_by_fitness[3])
